...
<div id="fig1" style="text-align: center;">
  <img src="/images/pll_cp_design/part2/topology_with_loop_notation.png" 
...
<div id="fig2" style="text-align: center;">
  <img src="/images/pll_cp_design/part2/topology_with_FB_notation.png" alt="topology_with_FB_notation" style="width:150%; display: block; margin: auto;" />
...
<div id="fig3" style="text-align: center;">
  <img src="/images/pll_cp_design/part2/dc_sweep_simulation_schematic.png" alt="dc_sweep_simulation_schematic" style="width:100%; display: block; margin: auto;" />
...
<div id="fig4" style="text-align: center;">
  <img src="/images/pll_cp_design/part2/dc_sweep_simulation_spice.png" alt="dc_sweep_simulation_spice" style="width:100%; display: block; margin: auto;" />
...
<div id="fig5" style="text-align: center;">
  <img src="/images/pll_cp_design/part2/current_mistmatches.png" alt="current_mistmatches" style="width:80%; display: block; margin: auto;" />
...
<div id="fig6" style="text-align: center;">
  <img src="/images/pll_cp_design/part2/m3_example.png" alt="m3_example" style="width:70%; display: block; margin: auto;" />
...
<table id="table1" style="border-collapse: collapse; width: 100%; text-align: center;">
  ...
  <tbody>
    <tr>
      ...
      <td style="border: 1px solid black; padding: 8px;"></td>
      <td style="border: 1px solid black; padding: 8px;">W = 4um, L = 0.6um</td>
    ...
    <tr>
      ...
      <td style="border: 1px solid black; padding: 8px;">W = 8um, L = 0.6um</td>
    ...
    <tr>
      ...
      <td style="border: 1px solid black; padding: 8px;">W = 2um, L = 0.15um</td>
    ...
    <tr>
      ...
      <td style="border: 1px solid black; padding: 8px;">W = 2um, L = 0.15um,<br>W = 1um, L = 0.15um</td>
    </tr>
    <tr>
      ...
      <td style="border: 1px solid black; padding: 8px;">W = 1um, L = 0.15um</td>
    </tr>
    <tr style="border-bottom: 3px solid black;">
    ...
    <tr>
      ...
      <td style="border: 1px solid black; padding: 8px;" rowspan="5">W = 2um, L = 0.15um,<br>W = 1um, L = 0.15um</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td style="border: 1px solid black; padding: 8px;">W = 6um, L = 4.4um</td>
    ...
    <tr style="border-bottom: 3px solid black;">
      ...
      <td style="border: 1px solid black; padding: 8px;">W = 2.6um, L = 2.6um</td>
    </tr>
  </tbody>
</table>
...
black;">
  <tr>
    <td style="border: 2px solid black; padding: 3px;">
      <img src="/images/pll_cp_design/part2/2_015_1_015.png" alt="Graph 1" style="width: 100%; max-width: 200px;">
      <br>
      <span>W<sub>p</sub> = 2um, L<sub>p</sub> = 0.15um<br>W<sub>n</sub> = 1um, L<sub>n</sub> = 0.15um</span>
    </td>
    <td style="border: 2px solid black; padding: 3px;">
      <img src="/images/pll_cp_design/part2/2_03_1_03.png" alt="Graph 2" style="width: 100%; max-width: 200px;">
      <br>
      <span>W<sub>p</sub> = 2um, L<sub>p</sub> = 0.3um<br>W<sub>n</sub> = 1um, L<sub>n</sub> = 0.3um</span>
    </td>
    <td style="border: 2px solid black; padding: 3px;">
      <img src="/images/pll_cp_design/part2/2_06_1_06.png" alt="Graph 3" style="width: 100%; max-width: 200px;">
      <br>
      <span>W<sub>p</sub> = 2um, L<sub>p</sub> = 0.6um<br>W<sub>n</sub> = 1um, L<sub>n</sub> = 0.6um</span>
    </td>
    <td style="border: 2px solid black; padding: 3px;">
      <img src="/images/pll_cp_design/part2/2_12_1_12.png" alt="Graph 4" style="width: 100%; max-width: 200px;">
      <br>
      <span>W<sub>p</sub> = 2um, L<sub>p</sub> = 1.2um<br>W<sub>n</sub> = 1um, L<sub>n</sub> = 1.2um</span>
    </td>
  </tr>
  <tr>
    <td style="border: 2px solid black; padding: 3px;">
      <img src="/images/pll_cp_design/part2/4_015_2_015.png" alt="Graph 5" style="width: 100%; max-width: 200px;">
      <br>
      <span>W<sub>p</sub> = 4um, L<sub>p</sub> = 0.15um<br>W<sub>n</sub> = 2um, L<sub>n</sub> = 0.15um</span>
    </td>
    <td style="border: 2px solid black; padding: 3px;">
      <img src="/images/pll_cp_design/part2/4_03_2_03.png" alt="Graph 6" style="width: 100%; max-width: 200px;">
      <br>
      <span>W<sub>p</sub> = 4um, L<sub>p</sub> = 0.3um<br>W<sub>n</sub> = 2um, L<sub>n</sub> = 0.3um</span>
    </td>
    <td style="border: 2px solid black; padding: 3px;">
      <img src="/images/pll_cp_design/part2/4_06_2_06.png" alt="Graph 7" style="width: 100%; max-width: 200px;">
      <br>
      <span>W<sub>p</sub> = 4um, L<sub>p</sub> = 0.6um<br>W<sub>n</sub> = 2um, L<sub>n</sub> = 0.6um</span>
    </td>
    <td style="border: 2px solid black; padding: 3px;">
      <img src="/images/pll_cp_design/part2/4_12_2_12.png" alt="Graph 8" style="width: 100%; max-width: 200px;">
      <br>
      <span>W<sub>p</sub> = 4um, L<sub>p</sub> = 1.2um<br>W<sub>n</sub> = 2um, L<sub>n</sub> = 1.2um</span>
    </td>
  </tr>
  <tr>
    <td style="border: 2px solid black; padding: 3px;">
      <img src="/images/pll_cp_design/part2/8_015_4_015.png" alt="Graph 9" style="width: 100%; max-width: 200px;">
      <br>
      <span>W<sub>p</sub> = 8um, L<sub>p</sub> = 0.15um<br>W<sub>n</sub> = 4um, L<sub>n</sub> = 0.15um</span>
    </td>
    <td style="border: 2px solid black; padding: 3px;">
      <img src="/images/pll_cp_design/part2/8_03_4_03.png" alt="Graph 10" style="width: 100%; max-width: 200px;">
      <br>
      <span>W<sub>p</sub> = 8um, L<sub>p</sub> = 0.3um<br>W<sub>n</sub> = 4um, L<sub>n</sub> = 0.3um</span>
    </td>
    <td style="border: 2px solid black; padding: 3px;">
      <img src="/images/pll_cp_design/part2/8_06_4_06.png" alt="Graph 11" style="width: 100%; max-width: 200px;">
      <br>
      <span>W<sub>p</sub> = 8um, L<sub>p</sub> = 0.6um<br>W<sub>n</sub> = 4um, L<sub>n</sub> = 0.6um</span>
    </td>
    <td style="border: 2px solid black; padding: 3px;">
      <img src="/images/pll_cp_design/part2/8_12_4_12.png" alt="Graph 12" style="width: 100%; max-width: 200px;">
      <br>
      <span>W<sub>p</sub> = 8um, L<sub>p</sub> = 1.2um<br>W<sub>n</sub> = 4um, L<sub>n</sub> = 1.2um</span>
    </td>
  </tr>
  <tr>
    <td style="border: 2px solid black; padding: 3px;">
      <img src="/images/pll_cp_design/part2/16_015_8_015.png" alt="Graph 13" style="width: 100%; max-width: 200px;">
      <br>
      <span>W<sub>p</sub> = 16um, L<sub>p</sub> = 0.15um<br>W<sub>n</sub> = 8um, L<sub>n</sub> = 0.15um</span>
    </td>
    <td style="border: 2px solid black; padding: 3px;">
      <img src="/images/pll_cp_design/part2/16_03_8_03.png" alt="Graph 14" style="width: 100%; max-width: 200px;">
      <br>
      <span>W<sub>p</sub> = 16um, L<sub>p</sub> = 0.3um<br>W<sub>n</sub> = 8um, L<sub>n</sub> = 0.3um</span>
    </td>
    <td style="border: 2px solid black; padding: 3px;">
      <img src="/images/pll_cp_design/part2/16_06_8_06.png" alt="Graph 15" style="width: 100%; max-width: 200px;">
      <br>
      <span>W<sub>p</sub> = 16um, L<sub>p</sub> = 0.6um<br>W<sub>n</sub> = 8um, L<sub>n</sub> = 0.6um</span>
    </td>
    <td style="border: 2px solid black; padding: 3px;">
      <img src="/images/pll_cp_design/part2/16_12_8_12.png" alt="Graph 16" style="width: 100%; max-width: 200px;">
      <br>
      <span>W<sub>p</sub> = 16um, L<sub>p</sub> = 1.2um<br>W<sub>n</sub> = 8um, L<sub>n</sub> = 1.2um</span>
    </td>
  </tr>
</table>
...
<div id="fig7" style="text-align: center;">
  <img src="/images/pll_cp_design/part2/topology2_condition1.png" alt="topology2_condition1" style="width:80%; display: block; margin: auto;" />
...
<div id="fig8" style="text-align: center;">
  <img src="/images/pll_cp_design/part2/effect_of_c2.png" alt="effect_of_c2" style="width:80%; display: block; margin: auto;" />
...
<div id="fig9" style="text-align: center;">
  <img src="/images/pll_cp_design/part2/opamp_basis_simulation_schematic.png" alt="opamp_basis_simulation_schematic" style="width:100%; display: block; margin: auto;" />
...
<table id="table3" style="border-collapse: collapse; width: 100%; text-align: center;">
  ...
  <tbody>
    <tr>
      ...
      <td style="border: 1px solid black; padding: 5px;" rowspan="2">W = 1um, L = 0.15um</td>
    ...
    <tr>
      ...
      <td style="border: 1px solid black; padding: 5px;" rowspan="2">W = 2um, L = 0.15um</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td style="border: 1px solid black; padding: 5px;">W = 4um, L = 0.15um</td>
    ...
    <tr>
      ...
      <td style="border: 1px solid black; padding: 5px;">W = 2um, L = 0.15um</td>
    </tr>
    <tr>
      ...
      <td style="border: 1px solid black; padding: 5px;">W = 10um, L = 0.5um</td>
    ...
    <tr>
      ...
      <td style="border: 1px solid black; padding: 5px; border-bottom: 3px solid black;">W = 5um, L = 0.5um</td>
    </tr>
    <tr>
      ...
      <td style="border: 1px solid black; padding: 5px;"></td>
      <td style="border: 1px solid black; padding: 5px;">L = 1um</td>
    ...
    <tr>
      ...
      <td style="border: 1px solid black; padding: 5px;">L = 1.14um</td>
      <td class="math-fallback" style="border: 1px solid black; padding: 5px; border-left: 3px solid black; border-right: 3px solid black;">$ \frac{1}{g_{m_{M9}}} $ value to cancel RHP zero of M9</td>
    </tr>
    <tr>
      ...
      <td style="border: 1px solid black; padding: 5px; border-bottom: 3px solid black;">L = 0.87um</td>
      <td class="math-fallback" style="border: 1px solid black; padding: 5px; border-bottom: 3px solid black; border-left: 3px solid black; border-right: 3px solid black;">$ \frac{1}{g_{m_{M10}}} $ value to cancel RHP zero of M10</td>
    </tr>
    <tr>
...
<div id="fig10" style="text-align: center;">
  <div style="display: flex; justify-content: center; align-items: center; gap: 10px;">
    <img src="/images/pll_cp_design/part2/opamp_basis_simulation_spice.png" 
         alt="opamp_basis_simulation_spice" 
         style="width: 100%; display: block; margin: auto;" />
    <img src="/images/pll_cp_design/part2/bode_plot_no_comp.png" 
...
<iframe src="https://www.youtube.com/embed/PT31xAEd_v4" title="YouTube video player" loading="lazy" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
...
<div id="fig11" style="text-align: center;">
  <div style="display: flex; justify-content: center; align-items: center; gap: 10px;">
    <img src="/images/pll_cp_design/part2/opamp1_topology.png" 
         alt="opamp1_topology" 
         style="width: 100%; display: block; margin: auto;" />
    <img src="/images/pll_cp_design/part2/opamp1_bode_plot.png" 
...
<div id="fig12" style="text-align: center;">
  <div style="display: flex; justify-content: center; align-items: center; gap: 10px;">
    <img src="/images/pll_cp_design/part2/opamp2_bode_plot.png" 
         alt="opamp2_bode_plot" 
         style="width: 100%; display: block; margin: auto;" />
    <img src="/images/pll_cp_design/part2/opamp3_bode_plot.png" 
...
<table id="table4" style="border-collapse: collapse; width: 100%; text-align: center;">
  ...
  <tbody>
    <tr>
      ...
      <td style="border: 1px solid black; padding: 3px;">8um X 8um</td>
      <td style="border: 1px solid black; padding: 3px;">10um X 10um</td>
      <td style="border: 1px solid black; padding: 3px; border-right: 3px solid black;">15um X  15um</td>
    </tr>
        <tr>
...
<div id="fig13" style="text-align: center;">
  <img src="/images/pll_cp_design/part2/transient_simulation_schematic.png" alt="transient_simulation_schematic" style="width:100%; display: block; margin: auto;" />
...
<div id="fig14" style="text-align: center;">
  <img src="/images/pll_cp_design/part2/transient_simulation_spice.png" alt="transient_simulation_spice" style="width:100%; display: block; margin: auto;" />
...
<div id="fig15" style="text-align: center;">
  <div style="display: flex; justify-content: center; align-items: center; gap: 10px;">
    <img src="/images/pll_cp_design/part2/case1_condition1.png" 
         alt="case1_condition1" 
         style="width: 100%; display: block; margin: auto;" />
    <img src="/images/pll_cp_design/part2/case1_condition1_closeup.png" 
...
<div id="fig16" style="text-align: center;">
  <div style="display: flex; justify-content: center; align-items: center; gap: 10px;">
    <img src="/images/pll_cp_design/part2/case1_condition2.png" 
         alt="case1_condition2" 
         style="width: 100%; display: block; margin: auto;" />
    <img src="/images/pll_cp_design/part2/case1_condition2_closeup.png" 
...
<div id="fig17" style="text-align: center;">
  <div style="display: flex; justify-content: center; align-items: center; gap: 10px;">
    <img src="/images/pll_cp_design/part2/case1_condition3.png" 
         alt="case1_condition3" 
         style="width: 100%; display: block; margin: auto;" />
    <img src="/images/pll_cp_design/part2/case1_condition3_closeup.png" 
...
<div id="fig18" style="text-align: center;">
  <div style="display: flex; justify-content: center; align-items: center; gap: 10px;">
    <img src="/images/pll_cp_design/part2/case2_condition1.png" 
         alt="case2_condition1" 
         style="width: 100%; display: block; margin: auto;" />
    <img src="/images/pll_cp_design/part2/case2_condition1_closeup.png" 
...
<div id="fig19" style="text-align: center;">
  <div style="display: flex; justify-content: center; align-items: center; gap: 10px;">
    <img src="/images/pll_cp_design/part2/case2_condition2.png" 
         alt="case2_condition2" 
         style="width: 100%; display: block; margin: auto;" />
    <img src="/images/pll_cp_design/part2/case2_condition2_closeup.png" 
...
<div id="fig20" style="text-align: center;">
  <div style="display: flex; justify-content: center; align-items: center; gap: 10px;">
    <img src="/images/pll_cp_design/part2/case2_condition3.png" 
         alt="case2_condition3" 
         style="width: 100%; display: block; margin: auto;" />
    <img src="/images/pll_cp_design/part2/case2_condition3_closeup.png" 
...
<div id="fig21" style="text-align: center;">
  <div style="display: flex; justify-content: center; align-items: center; gap: 10px;">
    <img src="/images/pll_cp_design/part2/case3_condition1.png" 
         alt="case3_condition1" 
         style="width: 100%; display: block; margin: auto;" />
    <img src="/images/pll_cp_design/part2/case3_condition1_closeup.png" 
...
<div id="fig22" style="text-align: center;">
  <div style="display: flex; justify-content: center; align-items: center; gap: 10px;">
    <img src="/images/pll_cp_design/part2/case3_condition2.png" 
         alt="case3_condition2" 
         style="width: 100%; display: block; margin: auto;" />
    <img src="/images/pll_cp_design/part2/case3_condition2_closeup.png" 
...
<div id="fig23" style="text-align: center;">
  <div style="display: flex; justify-content: center; align-items: center; gap: 10px;">
    <img src="/images/pll_cp_design/part2/case3_condition3.png" 
         alt="case3_condition3" 
         style="width: 100%; display: block; margin: auto;" />
    <img src="/images/pll_cp_design/part2/case3_condition3_closeup.png" 
...
<div id="fig24" style="text-align: center;">
  <div style="display: flex; justify-content: center; align-items: center; gap: 10px;">
    <img src="/images/pll_cp_design/part2/current_before_ff_cap_closeup.png" 
         alt="current_before_ff_cap_closeup" 
         style="width: 100%; display: block; margin: auto;" />
    <img src="/images/pll_cp_design/part2/vout_before_ff_cap.png" 
...
<div id="fig25" style="text-align: center;">
  <div style="display: flex; justify-content: center; align-items: center; gap: 10px;">
    <img src="/images/pll_cp_design/part2/current_after_ff_cap_closeup.png" 
         alt="current_after_ff_cap_closeup" 
         style="width: 100%; display: block; margin: auto;" />
    <img src="/images/pll_cp_design/part2/vout_after_ff_cap.png" 
...
> [Charge Pump Dead Zone Section](/posts/pll/pll-cp-design-part1/#charge-pump-dead-zone)
{: .prompt-info }

<br>

<div id="fig26" style="text-align: center;">
  <img src="/images/pll_cp_design/part2/dead_zone.png" alt="dead_zone" style="width:100%; display: block; margin: auto;" />
