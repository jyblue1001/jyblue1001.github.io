...
<img src="/images/third_order_pll.png" style="display: block; margin: auto;" alt="Diagram of a third order PLL" />
...
<img src="/images/second_order_pll.png" style="display: block; margin: auto;" alt="Diagram of a second-order PLL" />
...
- $R1$: 1st order loop filter resistor [ohms]
...
3. **I_p :** Arbitrarily set to 100uA as a starting point.  
