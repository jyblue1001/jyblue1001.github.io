...
Back in the post "Design Parameters Part 1," we left off **$C_1$**, **$R_1$**, and **Kvco** undecided.  
Now, with Kvco being set, we move on to the derivation of **$C_1$** and **$R_1$**.
...
<p class="equation-caption"><strong><span style="font-size: 16px;">Equation 1: 2nd order Closed Loop Transfer Function</span></strong></p>
...
<p class="equation-caption"><strong><span style="font-size: 16px;">Equation 2: Damping Factor</span></strong></p>
...
<p class="equation-caption"><strong><span style="font-size: 16px;">Equation 3: Natural Frequency</span></strong></p>

<br>

As **Eq.3** has just one unknown variable (**$C_1$**), we will start deriving from the natural frequency.  
...
<div style="text-align: center;">
  <img src="/images/pll_loop_filter_design/pll_pfd_cp_loop_filter_cascade.png" alt="PLL and Loop Filter Cascade" style="width:100%; display: block; margin: auto;" />
...
<div style="text-align: center;">
  <img src="/images/pll_loop_filter_design/ramp_response_signal.png" alt="Ramp Response Signal" style="width:100%; display: block; margin: auto;" />
...
But which bandwidth? **$\omega_{-3dB}$** (3dB cutoff bandwidth of the Closed Loop System) or **$\omega_u$** (unity-gain bandwidth of the Open Loop System)?
...
<p class="equation-caption"><strong><span style="font-size: 16px;">Equation 4: Open Loop Transfer Function</span></strong></p>

<br>

If this still raises concerns, we can take further validations.

Say we set the 2nd order system to have a damping factor (**$\zeta$**) of **1**, it shows as the figure below.  
In such (**$\zeta = 1$**) configuration, it shows the relationships of the bandwidths as **$\omega_{-3dB} \approx 2.5\omega_n$**, and **$\omega_u \approx 2.1\omega_n$**.  
By this, the two bandwidths are close in values, which means that even if we choose **$\omega_{-3dB}$** over **$\omega_u$**, we can still expect the similar results.
 

<div style="text-align: center;">
  <img src="/images/pll_loop_filter_design/pll_various_response.png" alt="Various PLL Response" style="width:100%; display: block; margin: auto;" />
...
<p class="equation-caption"><strong><span style="font-size: 16px;">Equation 5: Relationship of Reference, Unity-Gain, Natural Frequency</span></strong></p>
...
<p class="equation-caption"><strong><span style="font-size: 16px;">Equation 6: C1 Derivation</span></strong></p>

<br>

Therefore the value of $C_1$ = 8.42pF, and the value of $C_2$ taken as 1/5, which will be roughly $C_2$ = 1.68pF.

Configuring $C_1$ we can move on to the configuration of the $R_1$ value. As we set the damping factor ($\zeta$) as 1, the calculation starts from Eq.2 as below.
...
<p class="equation-caption"><strong><span style="font-size: 16px;">Equation 7: R1 Derivation</span></strong></p>

<br>

In conclusion, we have $R_1$ = 42.9kΩ.
...
<div style="text-align: center;">
  <img src="/images/pll_loop_filter_design/design_parameters.png" alt="Design Parameters" style="width:100%; display: block; margin: auto;" />
...
<div style="text-align: center;">
  <img src="/images/pll_loop_filter_design/simulink_diagram.png" alt="Simulink Diagram" style="width:100%; display: block; margin: auto;" />
...
<div style="text-align: center;">
  <img src="/images/pll_loop_filter_design/pll_circuit_representation.png" alt="PLL Circuit Representation" style="width:100%; display: block; margin: auto;" />
...
<div style="text-align: center;">
  <img src="/images/pll_loop_filter_design/step_response_bode_diagram.png" alt="Step Response, Bode Plot" style="width:100%; display: block; margin: auto;" />
...
<div style="text-align: center;">
  <img src="/images/pll_loop_filter_design/xschem_implementation.png" alt="Xschem Implementation" style="width:100%; display: block; margin: auto;" />
