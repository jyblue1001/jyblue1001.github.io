...
<div style="text-align: center;">
  <img src="/images/pll_cp_design/part1/topology1.png" alt="topology1" style="width:100%; display: block; margin: auto;" />
...
<div style="text-align: center;">
  <img src="/images/pll_cp_design/part1/dc_sweep_spice_code.png" alt="dc_sweep_spice_code" style="width:150%; display: block; margin: auto;" />
  <p><strong>Figure 2</strong></p>
</div>

<div style="text-align: center;">
  <img src="/images/pll_cp_design/part1/dc_response.png" alt="dc_response" style="width:100%; display: block; margin: auto;" />
...
<div style="text-align: center;">
  <img src="/images/pll_cp_design/part1/transient_topology.png" alt="transient_topology" style="width:100%; display: block; margin: auto;" />
...
<div style="text-align: center;">
  <img src="/images/pll_cp_design/part1/input_pulses.png" alt="input_pulses" style="width:80%; display: block; margin: auto;" />
...
<div style="text-align: center;">
  <img src="/images/pll_cp_design/part1/transient_spice_code.png" alt="transient_spice_code" style="width:100%; display: block; margin: auto;" />
  <p><strong>Figure 6</strong></p>
</div>

<br>

Fig.6 is the SPICE code for the transient response simulations with some comments explaining some of the code lines. The reason for choosing timesteps 50ps and 5ps is related to the validation of unwanted oscillations. In simulations, the rule of thumb for selecting the appropriate timesteps is to choose a <sup>1</sup>/<sub>10</sub> value, and our frequency of interest is the reference frequency, which is 20MHz, 5x10<sup>-8</sup> s (50ns). Thus, we could choose a timestep of 5ns. However, to further validate for possible oscillations that could arise from amplifications in parasitic capacitances, smaller timesteps 50ps and 5ps were chosen.

<br>

<div style="text-align: center;">
  <!-- First Image -->
  <img src="/images/pll_cp_design/part1/freq_vs_vcont.png" alt="freq_vs_vcont" style="width: 80%; display: block; margin: auto;" />
...
<p class="equation-caption"><strong><span style="font-size: 18px;">Equation 1: V_cont Derivation </span></strong></p>
...
<div style="text-align: center;">
  <div style="display: flex; justify-content: center; align-items: center; gap: 10px;">
    <img src="/images/pll_cp_design/part1/first_condition_pulse.png" 
         alt="first_condition_pulse" 
         style="width: 100%; display: block; margin: auto;" />
    <img src="/images/pll_cp_design/part1/first_condition_pulse_closeup.png" 
...
<div style="text-align: center;">
  <div style="display: flex; justify-content: center; align-items: center; gap: 10px;">
    <img src="/images/pll_cp_design/part1/first_condition_current_response.png" 
         alt="first_condition_current_response" 
         style="width: 100%; display: block; margin: auto;" />
    <img src="/images/pll_cp_design/part1/first_condition_current_response_closeup.png" 
...
<div style="text-align: center;">
  <div style="display: flex; justify-content: center; align-items: center; gap: 10px;">
    <img src="/images/pll_cp_design/part1/second_condition_pulse.png" 
         alt="second_condition" 
         style="width: 100%; display: block; margin: auto;" />
    <img src="/images/pll_cp_design/part1/second_condition_pulse_closeup.png" 
...
<div style="text-align: center;">
  <div style="display: flex; justify-content: center; align-items: center; gap: 10px;">
    <img src="/images/pll_cp_design/part1/second_condition_current_response.png" 
         alt="second_condition_current_response" 
         style="width: 100%; display: block; margin: auto;" />
    <img src="/images/pll_cp_design/part1/second_condition_current_response_closeup.png" 
...
<div style="text-align: center;">
  <div style="display: flex; justify-content: center; align-items: center; gap: 10px;">
    <img src="/images/pll_cp_design/part1/third_condition_pulse_closeup.png" 
         alt="third_condition_current_response" 
         style="width: 100%; display: block; margin: auto;" />
    <img src="/images/pll_cp_design/part1/third_condition_pulse.png" 
...
<div style="text-align: center;">
  <div style="display: flex; justify-content: center; align-items: center; gap: 10px;">
    <img src="/images/pll_cp_design/part1/third_condition_current_response.png" 
         alt="third_condition_current_response" 
         style="width: 100%; display: block; margin: auto;" />
    <img src="/images/pll_cp_design/part1/third_condition_current_response_closeup.png" 
         alt="third_condition_current_response_closeup" 
         style="width: 100%; display: block; margin: auto;" />
  </div>
...
<div style="text-align: center;">
  <div style="display: flex; justify-content: center; align-items: center; gap: 10px;">
    <img src="/images/pll_cp_design/part1/revised_third_condition_current_response.png" 
         alt="third_condition_current_response" 
         style="width: 100%; display: block; margin: auto;" />
    <img src="/images/pll_cp_design/part1/revised_third_condition_current_response_closeup.png" 
         alt="third_condition_current_response_closeup" 
         style="width: 100%; display: block; margin: auto;" />
  </div>
...
<div style="text-align: center;">
  <img src="/images/pll_cp_design/part1/big_transistors.png" alt="big_transistors" style="width:100%; display: block; margin: auto;" />
...
<div style="text-align: center;">
  <img src="/images/pll_cp_design/part1/mismatches_dc.png" alt="mismatches_dc" style="width:100%; display: block; margin: auto;" />
...
<div style="text-align: center;">
  <div style="display: flex; justify-content: center; align-items: center; gap: 10px;">
    <img src="/images/pll_cp_design/part1/F_VCO_delay_13ns.png" 
         alt="F_VCO_delay_13ns" 
         style="width: 100%; display: block; margin: auto;" />
    <img src="/images/pll_cp_design/part1/F_VCO_delay_13ns_closeup.png" 
...
<div style="text-align: center;">
  <img src="/images/pll_cp_design/part1/dead_zone_spice.png" alt="dead_zone_spice" style="width:100%; display: block; margin: auto;" />
...
<div style="text-align: center;">
  <div style="display: flex; justify-content: center; align-items: center; gap: 10px;">
    <img src="/images/pll_cp_design/part1/F_VCO_lag_10ns_1us.png" 
         alt="F_VCO_lag_10ns_1us" 
         style="width: 100%; display: block; margin: auto;" />
    <img src="/images/pll_cp_design/part1/F_VCO_lag_10ns_1us_closeup.png" 
...
<div style="text-align: center;">
  <img src="/images/pll_cp_design/part1/dead_zone.png" alt="dead_zone" style="width:100%; display: block; margin: auto;" />
...
One might think of a solution by changing the length of M13 (0.15um to 0.5um) and M14 (0.15um to 1.0um), to match the 100uA output, which is shown in fig.21.

<br>

<div style="text-align: center;">
  <img src="/images/pll_cp_design/part1/CP_branch_resize.png" alt="CP_branch_resize" style="width:100%; display: block; margin: auto;" />
...
<div style="text-align: center;">
  <img src="/images/pll_cp_design/part1/DC_analysis_contradiction.png" alt="DC_analysis_contradiction" style="width:100%; display: block; margin: auto;" />
